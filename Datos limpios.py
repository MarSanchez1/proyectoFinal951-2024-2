...
if __name__ == "__main__":
    ...
    df['Precios'] = df['Precios'].fillna("Sin precio")
    df['Direcciones'] = df['Direcciones'].fillna("Dirección no informada")
    df['Dimensiones'] = df['Dimensiones'].fillna("Sin dimensiones")
